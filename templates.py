...
def dev_mail_template(name, api_key):
    message = MIMEMultipart()
...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<h3>
				This is your SECRET KEY {api_key}
                don't share this key to anyone, this is a company private key.<br>If we find anything illegal we are just and the developer
			</h3>
...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<h3>
				Your account has been deleted, If you not delete that account<br>Reply in this mail!!!
			</h3>
